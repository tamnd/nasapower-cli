...
// HTTP behaviour is covered in nasapower_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "nasapower://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("nasapower", "about")
	if err != nil || got.String() != "nasapower://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want nasapower://page/about", got.String(), err)
	}
}
