...
```
nasapower <command> [arguments] [flags]
```

Run `nasapower <command> --help` for the full flag list on any command. This
...
per operation you declare in `nasapower/domain.go`.
