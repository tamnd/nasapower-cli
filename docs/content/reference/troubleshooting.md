...
Most of these come down to network reality or how nasapower serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

nasapower rate-limits like any public site. nasapower already paces
...
Where a surface is gated, nasapower reads a cookie or token you supply
...
`nasapower`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what nasapower actually did
